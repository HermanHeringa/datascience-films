/*
Joins the tables usd.cities, usd.events and usd.reports into one table to be used
then combine the gdelt data into the table 

new table is called data.news 
*/

create or replace procedure data.join_news_tables() as $$
